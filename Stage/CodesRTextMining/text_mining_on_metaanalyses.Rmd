...
```
Le tableau ci-dessus présente les co-occurence de mots pour chacune des sections de 10 lignes définies au préalable, filtré pour que le premier mot soit "earthworm". Dans une section de dix lignes, les trois groupes de mots qui reviennent le plus souvent et commençant par "earthworm" sont donc **earthworm + earthworms** (sans doute la fin d'une phrase et le début d'une autre), **earthworm + effects** et **"earthworm + experiment"**.<br>

On veut maintenant observer les corrélations entre les mots: nb de fois où ils apparaissent ensemble / nb de fois où ils apparaissent séparément (coefficient Phi, équiv. corrélation de Pearson).<br>
...
<br>Le calcul des corrélations à l'intérieur de groupes de cinq lignes montre les termes fréquement employés au voisinage des mots choisis pour cette première partie d'analyse (*earthworm/plant/soil*).<br>
**earthworm:** *"invasion", "forest", "hardwood", "northern"*. On peut en déduire que dans les textes du corpus, les vers de terre sont souvent liés à des invasions dans les forêts de feuillus d'Amérique du nord. On retrouve ici un thème important de la MA3.<br>
**plants:** *plant", "detritivores", "aphid", "herbivores"*. On peut en déduire que dans les textes du corpus, les plantes sont souvent mentionnées en lien avec les pucerons, les détritivores et les herbivores. On retrouve ici un thème important de la MA2.<br>
**soil:** *"anecic", "respiration", "american"*. Les vers de terres anéciques sont une classe de vers de terre définie par M. B. Bouché (*Stratégie lombricienne*, 1977), dont l'une des caractéristiques principales était de creuser de profondes galeries dans le sol (1 à 6 mètres de profondeur). On peut donc penser qu'ils participent très fortement à la *respiration* des sols, probablement plus que les deux autres classes (épigés et endogés), qui, par définition, creusent moins profondément. La présence du mot *"american"* sous-entends que les vers de terre anéciques sont particulièrement surveillées en Amérique. On retrouve ici un terme important de la MA1 (la racine "pool" n'apparaît que dans la MA1 dans la mesure de la fréquence des mots).<br>
...
<br>Le calcul des corrélations à l'intérieur de groupes de cinq lignes montre les termes fréquement employés au voisinage des mots choisis pour cette troisième partie d'analyse. Les mots ont été choisis spécifiquement pour tenter de grouper les données selon la région géographique.<br>
...
<!-- Le double espace "  " à la fin d'un mots fait pareil que <br> -->
