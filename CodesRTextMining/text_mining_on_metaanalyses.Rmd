...
data("stop_words")
custom_stop_words <- tibble(word = c("plot","wild","slug","manipulation","apple","significant","free","led","lead","warm","fresh"),  
...
Le terme *"strong"* est commun à toutes les métaanlayses. Cependant, sa valence peut grandement dépendre du contexte de son utilisation. On peut constater que le mot positif *"rich/enrich"* est retrouvé dans la plupart de métaanalyses (1,2 et 3). le mot *"lead"* n'est retrouvé que dans les MA1, 3 et 4. Le mot *"benefit"* n'est retrouvé que dans les MA2 et 4. Le mot *"protect"* n'est retrouvé que dans la MA3. Le mot *"benefit"* n'est retrouvé que dans les MA2 et 4.

On peut constater qu'il n'y a aucun mot négatif commun à tous les corpus. Le mot *"disturb"* n'est retrouvé que dans les MA 1 et 3, et le mot *"infest"* seulement dans les MA 2 et 4.
On peut aussi remarquer que le mot *"loss"* n'est retrouvé que dans les MA1 et 4, ce qui semble indiquer que les effets négatifs relevés ne sont pas forcément liés à des pertes de caractéristiques. Le mot *"sever"*, à l'inverse, n'est retrouvé que dans les MA3 et 4, ce qui signifie peut-être qu'elles sont plus "quantitatives" que les deux autres. 
...
* *MA1:* "strong", profound", "enrich","rapid".<br>
* *MA2:* "strong", "prefer", "enrich","benefit".<br>
* *MA3:* "rich", "support", "strong", "protect".<br>
* *MA4:* "success", "fine","strong","top".<br>

<u>MA1 et 2:</u> Le mot *"enrich"* est le troisième plus grand contributeurs positif aux scores de sentiment des MA1 et 2. Par ailleurs, le terme évoque un processus dynamique, et la présence de *"rich"* (MA1), ou encore de *"benefit"* et *"boost"* (MA2) semble évoquer un processus écologique bénéfique, peut-être en terme de richesse spécifique et écosystémique. <br>
<u>MA2 et 3:</u>Le *"rich"* en première position de la MA3 semble pointer aussi vers une étude écosystémique, mais cette-fois, ce mot seul n'indique pas la direction du changement (là où *"enrich"* désigne une croissance de richesse à lui seul, le sens de *"rich"* dépend grandement du contexte, car le mot seul ne donne aucune indication sur le sens de la variation). Cependant, le terme *"protect"* semble indiquer un effet positif du vers de terre sur les végétaux. La présence de *"benefit"* semble rapprocher la MA2 de la MA3 (*"protect"*).<br>
Dans la MA4, les mots *"success", "fine"* et *"strong"* dégagent une impression positive. Avec *"gain"* et *"benefit"*, et en s'appuyant sur le titre de la métaanalyse, il semble raisonnable de penser que les vers de terre ont une influence positive ("strong", "gain", "benefit") sur la production végétale.<br>

<u>Les quatre mots négatifs les plus importants en contribution sont: </u><br> 
* *MA1:* "loss", "temper", "poor", "disturb".<br>
* *MA2:* "drought", "infest", "dead","complex".<br>
* *MA3:* "disturb", "burn", "sever","temper".<br>
* *MA4:* "infest", "sever", "loss","pest".<br>
...
<u>MA1 et 4:</u>Dans les MA1 et 4, la présence de *"loss"* et *"disturb"*(MA1), ou bien *"loss"* et *"pest"* (MA4) va aussi dans ce sens, présentant le vers de terre comme un problème, qui, sans forcément détruire totalement l'environnement natif, le **perturbe** (MA1) ou est perçu comme un **nuisible** (MA4).<br>
La MA2 semble légèrement différente des autres dans son approche, <u>avec des mots uniques qui lui sont propres</u> tels que *"drought"* ou bien *"dead"*. D'autres mots comme *"stress"* ou *"inhibit"*, au vu du titre de la métaanalyse, semblent relever des effets négatifs sur les plantes.<br>
**De manière générale, pour chaque MA toutes proportions gardées (voir l'échelle des plots sur l'axe Ox), les mots négatifs semblent plus importants en contribution que les mots positifs. Dans ce corpus, le sentiment négatif semble donc plus prononcé que le sentiment positif.**<br>
...
- **MA1/MA2:** étude de l'impact écologique des vers de terre sur les écosystèmes (richesse spécifique).<br>
- **MA2/MA3:** étude des effets **positifs** (protection et bénéfices) des vers de terre sur la physiologie végétale MAIS nuance car vision négative des vers de terre (espèce invasive) pour la MA2.<br>
- **MA4:** étude de l'influence des vers de terre invasifs sur la production végétale MAIS nuance car vision négative des vers de terre (espèce invasive).
...
```
<br>
Le tablau ci-dessus présente, pour chaque MA, le rapport mot positifs / total sentiment (colonne "positive ratio") et le le rapport mot négatifs / total sentiment (colonne "negative ratio"). On peut donc classer les ma On peut donc écrire, de manière synthétique, que:<br>
