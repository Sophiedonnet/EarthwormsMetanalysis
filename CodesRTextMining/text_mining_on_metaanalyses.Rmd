...
```{r ggarrange contrib,fig.height=10, fig.width=20}
library(egg)
...
- Les mots *"tim" (forme de "times" après 'singularize'?)*, *"contribute"*, *"stage"* et *"responsible"* sont plus souvent employés dans la MA3 que dans les autres MA.<br> Les mots *"canopy"* et *"aggregate"* sont aussi plus présent dans la MA3 que dans les autres MA.<br>
